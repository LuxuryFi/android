...
public class Upload {
    ...
    public Upload(int id, String dayOfWeek, String time, int capacity, int duration, double price, String classType, String description, String teacher, String image) {
        this.id = id;
